...
const PromptCard = ({ prompt, handleTag, handleUpdate, handleDelete }) => {
  ...
  return (
    <div className="prompt_card">
      ...
      <p className="font-inter text-sm blue_gradient cursor-pointer" onClick={() => handleTag && handleTag(prompt.tag)}>
        {prompt.tag}
      </p>
    </div>
  )
